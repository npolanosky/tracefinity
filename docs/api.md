...
- `POST /api/sessions/{id}/name-tools` - optionally auto-name traced polygons from their crops (synchronous, best-effort; needs a Gemini/OpenRouter key or a local Ollama vision model)
